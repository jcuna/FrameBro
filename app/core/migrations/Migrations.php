...
abstract class Migrations implements DatabaseAccessInterface
{
     ...
     * @param bool $down
     */
    public function __construct($down = false)
    {
     ...
     * @throws \Exception
     */
    public function create($tableName, \Closure $closure)
    {
     ...
     * @throws \Exception
     */
    public function update($tableName, \Closure $closure)
    {
        $this->table = $tableName;
     ...
     * @return bool
     */
    public function isActualError($errorMessage, Table $table)
    {
     ...
     * @return bool
     */
    public function handleUnknownColumn($message, Table $table)
    {
